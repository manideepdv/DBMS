...
<div class="w3-main" style="margin-left:300px">
 ...
 <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>Vote for Democracy ${username}</b></h1>
 ...
 <div class="container">
        <div class="table-wrapper">
            ...
            <form action="/DBMS/checkServlet?UID={UID}" method="get">
            <table class="table table-bordered">
                ...
                <tbody>
                						<c:forEach items="${list_cd}" var="cad">
                									<tr>
					                                     <td>${cad.firstname} ${cad.lastname}</td> 
                                                         <td>${cad.partyname}</td>
														 <td> <label> <input type="radio" name="option" value="${cad.partyname}"> </label></td>
				                                   </tr>
										</c:forEach>
                </tbody>
            </table>
            ...
            <button style="width:150px" type="submit" name="ans" id="bt" value="" onclick="myFunction()">Submit</button>
            </form>
        </div>
    </div>   
...
function myFunction(){
    ...
    for(i = 0; i < ele.length; i++) { 
        if(ele[i].checked) {
        var res=document.getElementById("bt");
        res.value=ele[i].value;
        }
    } 
}
function w3_open() {
